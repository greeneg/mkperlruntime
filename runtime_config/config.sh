...
archlibexp='%PREFIX%/lib/perl5/%VERSION%/x86_64-linux-thread-multi-ld'
archname64=''
...
cc='cc'
cccdlflags='-fPIC'
ccdlflags='-Wl,-E -Wl,-rpath,%PREFIX%/lib/perl5/%VERSION%/x86_64-linux-thread-multi-ld/CORE'
ccflags='-D_REENTRANT -D_GNU_SOURCE -fwrapv -DSOCKS -fno-strict-aliasing -pipe -fstack-protector-strong -I/usr/local/include -I/usr/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_FORTIFY_SOURCE=2'
ccflags_uselargefiles='-D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64'
ccname='gcc'
ccsymbols=''
ccversion=''
cf_by='greeneg'
cf_email='greeneg@tolharadys.net'
cf_time='Thu Feb  6 22:03:25 EST 2020'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
html1direxp='%PREFIX%/share/doc/HTML'
html3dir='%PREFIX%/share/doc/HTML'
html3direxp='%PREFIX%/share/doc/HTML'
i16size='2'
i16type='short'
i32size='4'
i32type='int'
...
incpath=''
incpth='/usr/lib64/gcc/x86_64-suse-linux/7/include /usr/local/include /usr/lib64/gcc/x86_64-suse-linux/7/include-fixed /usr/lib64/gcc/x86_64-suse-linux/7/../../../../x86_64-suse-linux/include /usr/include /usr/lib64/gcc/x86_64-suse-linux/7/include /usr/local/include /usr/lib64/gcc/x86_64-suse-linux/7/include-fixed /usr/lib64/gcc/x86_64-suse-linux/7/../../../../x86_64-suse-linux/include /usr/include'
inews=''
initialinstalllocation='%PREFIX%/bin'
installarchlib='%PREFIX%/lib/perl5/%VERSION%/x86_64-linux-thread-multi-ld'
installbin='%PREFIX%/bin'
installhtml1dir='%PREFIX%/share/doc/HTML'
installhtml3dir='%PREFIX%/share/doc/HTML'
installman1dir='%PREFIX%/share/man/man1'
installman3dir='%PREFIX%/share/man/man3'
installprefix='%PREFIX%'
installprefixexp='%PREFIX%'
installprivlib='%PREFIX%/lib/perl5/%VERSION%'
installscript='%PREFIX%/bin'
installsitearch='%PREFIX%/lib/perl5/site_perl/%VERSION%/x86_64-linux-thread-multi-ld'
installsitebin='%PREFIX%/bin'
installsitehtml1dir='%PREFIX%/share/doc/HTML'
installsitehtml3dir='%PREFIX%/share/doc/HTML'
installsitelib='%PREFIX%/lib/perl5/site_perl/%VERSION%'
...
lddlflags='-shared -O2 -L/lib64 -L/usr/lib64 -fstack-protector-strong'
ldflags=' -fstack-protector-strong -L/lib64 -L/usr/lib64'
...
libc='libc-2.26.so'
libperl='libperl.so'
libpth='/usr/local/lib /usr/lib64/gcc/x86_64-suse-linux/7/include-fixed /usr/lib64/gcc/x86_64-suse-linux/7/../../../../x86_64-suse-linux/lib /usr/lib /lib/../lib64 /usr/lib/../lib64 /lib /lib64 /usr/lib64 /usr/local/lib64 /usr/local/lib /usr/lib64/gcc/x86_64-suse-linux/7/include-fixed /usr/lib64/gcc/x86_64-suse-linux/7/../../../../x86_64-suse-linux/lib /usr/lib'
libs='-lpthread -lnsl -lgdbm -ldb -ldl -lm -lcrypt -lutil -lc -lgdbm_compat'
libsdirs=''
libsfiles=''
libsfound=''
libspath=' /usr/local/lib /usr/lib64/gcc/x86_64-suse-linux/7/include-fixed /usr/lib64/gcc/x86_64-suse-linux/7/../../../../x86_64-suse-linux/lib /usr/lib /lib/../lib64 /usr/lib/../lib64 /lib /lib64 /usr/lib64 /usr/local/lib64 /usr/local/lib /usr/lib64/gcc/x86_64-suse-linux/7/include-fixed /usr/lib64/gcc/x86_64-suse-linux/7/../../../../x86_64-suse-linux/lib /usr/lib'
libswanted='cl pthread socket inet nsl gdbm dbm db malloc dl ld sun m crypt sec util c cposix posix ucb BSD gdbm_compat socks5 socks5_sh'
...
man1direxp='%PREFIX%/share/man/man1'
man1ext='1'
man3dir='%PREFIX%/share/man/man3'
man3direxp='%PREFIX%/share/man/man3'
man3ext='3'
mips_type=''
mistrustnm=''
mkdir='mkdir'
...
mydomain='.tolharadys.net'
myhostname='erik'
myuname='linux erik 5.4.13-1.g5cf5394-default #1 smp sat jan 18 09:42:02 utc 2020 (5cf5394) x86_64 x86_64 x86_64 gnulinux '
n='-n'
need_va_copy='define'
...
orderlib='false'
osname='linux'
osvers='5.4.13-1.g5cf5394-default'
otherlibdirs=' '
package='perl5'
...
perladmin='greeneg@tolharadys.net'
perllibs='-lpthread -lnsl -ldl -lm -lcrypt -lutil -lc'
perlpath='%PREFIX%/bin/perl'
pg='pg'
phostname='hostname'
pidtype='pid_t'
plibpth='/lib/x86_64-suse-linux/7 /lib/../lib64 /usr/lib/x86_64-suse-linux/7 /usr/lib/../lib64 /lib /usr/lib'
pmake=''
pr=''
prefix='%PREFIX%'
prefixexp='%PREFIX%'
privlib='%PREFIX%/lib/perl5/%VERSION%'
privlibexp='%PREFIX%/lib/perl5/%VERSION%'
...
sitearchexp='%PREFIX%/lib/perl5/site_perl/%VERSION%/x86_64-linux-thread-multi-ld'
sitebin='%PREFIX%/bin'
sitebinexp='%PREFIX%/bin'
sitehtml1dir='%PREFIX%/share/doc/HTML'
sitehtml1direxp='%PREFIX%/share/doc/HTML'
sitehtml3dir='%PREFIX%/share/doc/HTML'
sitehtml3direxp='%PREFIX%/share/doc/HTML'
sitelib='%PREFIX%/lib/perl5/site_perl/%VERSION%'
sitelib_stem='%PREFIX%/lib/perl5/site_perl'
sitelibexp='%PREFIX%/lib/perl5/site_perl/%VERSION%'
siteman1dir='%PREFIX%/share/man/man1'
siteman1direxp='%PREFIX%/share/man/man1'
siteman3dir='%PREFIX%/share/man/man3'
siteman3direxp='%PREFIX%/share/man/man3'
siteprefix='%PREFIX%'
siteprefixexp='%PREFIX%'
sitescript='%PREFIX%/bin'
sitescriptexp='%PREFIX%/bin'
sizesize='8'
sizetype='size_t'
sleep=''
smail=''
