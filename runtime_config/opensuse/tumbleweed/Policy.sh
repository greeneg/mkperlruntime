...
#     %PREFIX%, so it isn't included here either.
#
...
# archlib='%PREFIX%/lib/perl5/%VERSION%/x86_64-linux-thread-multi-ld'
...
html1dir='%PREFIX%/share/doc/HTML'
# Preserving custom html3dir
html3dir='%PREFIX%/share/doc/HTML'
# sitebin='%PREFIX%/bin'
# sitescript='%PREFIX%/bin'
# sitelib='%PREFIX%/lib/perl5/site_perl/%VERSION%'
# sitearch='%PREFIX%/lib/perl5/site_perl/%VERSION%/x86_64-linux-thread-multi-ld'
# Preserving custom siteman1dir
siteman1dir='%PREFIX%/share/man/man1'
# Preserving custom siteman3dir
siteman3dir='%PREFIX%/share/man/man3'
# Preserving custom sitehtml1dir
sitehtml1dir='%PREFIX%/share/doc/HTML'
# Preserving custom sitehtml3dir
sitehtml3dir='%PREFIX%/share/doc/HTML'
# vendorbin=''
# vendorscript=''
# vendorlib=''
# vendorarch=''
