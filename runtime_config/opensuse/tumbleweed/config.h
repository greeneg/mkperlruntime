...
/* Package name      : perl5
 * Source directory  : .
 * Configuration time: Mon Feb 24 21:20:17 EST 2020
 * Configured by     : greeneg
 * Target system     : linux fenrir.tolharadys.net 5.5.4-1-default #1 smp sat feb 15 08:16:55 utc 2020 (119f9ca) x86_64 x86_64 x86_64 gnulinux 
 */
 ...
 */
#define ARCHLIB "%PREFIX%/lib/perl5/%VERSION%/x86_64-linux-thread-multi-ld"		/**/
#define ARCHLIB_EXP "%PREFIX%/lib/perl5/%VERSION%/x86_64-linux-thread-multi-ld"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define PRIVLIB "%PREFIX%/lib/perl5/%VERSION%"		/**/
#define PRIVLIB_EXP "%PREFIX%/lib/perl5/%VERSION%"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "%PREFIX%/lib/perl5/site_perl/%VERSION%/x86_64-linux-thread-multi-ld"		/**/
#define SITEARCH_EXP "%PREFIX%/lib/perl5/site_perl/%VERSION%/x86_64-linux-thread-multi-ld"		/**/
 ...
 */
#define SITELIB "%PREFIX%/lib/perl5/site_perl/%VERSION%"		/**/
#define SITELIB_EXP "%PREFIX%/lib/perl5/site_perl/%VERSION%"		/**/
#define SITELIB_STEM "%PREFIX%/lib/perl5/site_perl"		/**/
 ...
 *	some shell.
 */
#define STARTPERL "#!%PREFIX%/bin/perl"		/**/
